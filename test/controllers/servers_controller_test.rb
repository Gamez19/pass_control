...
class ServersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create server" do
    assert_difference('Server.count') do
      post servers_url, params: { server: { direccion: @server.direccion, nombre: @server.nombre } }
    end
  ...
  test "should update server" do
    patch server_url(@server), params: { server: { direccion: @server.direccion, nombre: @server.nombre } }
